...
export default function Home({ drawerOpen = false, onOpenProject, onCloseProject }: PageProps) {
  ...
  const activeCaseProgress = progressBySlug[activeCase?.slug ?? ""] ?? 0;
  const isArchive = activeSlug === "archive";
  const isSkills = activeSlug === "skills";
  const isServices = activeSlug === "services";
  const showMobileCasePreview = !isSkills && !isServices && !isArchive;
      ...
      <main className="pb-20 pt-28 sm:pt-32 md:pt-28">
        <Container>
          ...
          <section className="mb-14 border-t border-neutral-100 pt-10 md:mb-[4.5rem] md:pt-12 xl:mb-20 xl:pt-14">
            {activeImmersive ? (
              <article className="rounded-[26px] border border-neutral-100 bg-white p-2.5 shadow-[0_24px_60px_rgba(17,17,17,0.05)] transition duration-300 hover:shadow-[0_28px_70px_rgba(17,17,17,0.06)] sm:p-3 md:rounded-[30px] md:p-4">
                <div
                  className="relative overflow-hidden rounded-[24px] border border-white/10 bg-[#06080d] shadow-[inset_0_1px_0_rgba(255,255,255,0.08)]"
                >
                  {hasImmersiveVideo ? (
                    <div className="absolute inset-0 bg-[#06080d]">
                      ...
                      >
                        <source src={activeImmersiveVideo} type="video/mp4" />
                      </video>
                    </div>
                  ) : (
                    <div
                    ...
                    <div className="grid gap-4 border-t border-white/10 pt-5 lg:grid-cols-[1fr_auto] lg:items-end">
                      ...
                      <div className="flex flex-wrap items-center gap-2 lg:justify-end">
                        ...
                        <div className="min-w-[72px] text-center text-[11px] uppercase tracking-[0.14em] text-white/70">
                          {String(activeImmersiveIndex + 1).padStart(2, "0")} / {String(immersivePreview.length).padStart(2, "0")}
                        </div>
                        ...
                        >
                          {t.home.immersive.cta} <span className="text-white/60">&rarr;</span>
                        </button>
                      </div>
                    </div>
                  </div>
          ...
          <section className="grid gap-10 xl:grid-cols-[0.42fr_0.58fr]">
            <div id="work" className="scroll-mt-24 overflow-x-clip xl:pb-[60vh]">
              <div className="flex items-center justify-between gap-4 border-b border-neutral-100 pb-4">
                ...
                >
                  {t.home.work.archive} <span className="text-neutral-400">&rarr;</span>
                </button>
              </div>
              ...
              <div className="xl:hidden sticky top-[28svh] z-10 mt-6 mb-3">
                <motion.div
                  ...
                  animate={{
                    ...
                    scale: showMobileCasePreview ? 1 : 0.982,
                    filter: showMobileCasePreview ? "blur(0px)" : "blur(10px)",
                  }}
                  transition={{ duration: 0.38, ease: [0.22, 1, 0.36, 1] }}
                  className="overflow-hidden rounded-[30px] border border-black/6 bg-[linear-gradient(180deg,rgba(255,255,255,0.98)_0%,rgba(251,251,251,0.95)_100%)] p-4 shadow-[0_18px_42px_rgba(15,23,42,0.04)]"
                >
                  <Link
                    to={`/work/${activeCase.slug}`}
                    className="group block overflow-hidden rounded-[24px] border border-black/6 bg-white/82 focus:outline-none focus-visible:ring-2 focus-visible:ring-neutral-300 focus-visible:ring-offset-2"
                  >
                    <AnimatePresence initial={false} mode="wait">
                      <motion.div
                        key={activeCase.slug}
                        initial={{ opacity: 0, y: 16, filter: "blur(10px)", scale: 1.015 }}
                        animate={{ opacity: 1, y: 0, filter: "blur(0px)", scale: 1 }}
                        exit={{ opacity: 0, y: -8, filter: "blur(10px)", scale: 0.992 }}
                      ...
                      >
                        <div className="overflow-hidden rounded-[20px] border-b border-black/6 bg-white">
                          <div className="relative aspect-[1.12/1]">
                            <img
                              ...
                              className="h-full w-full object-contain p-6 transition-transform duration-500 ease-[cubic-bezier(0.22,1,0.36,1)] group-hover:scale-[1.012]"
                              draggable={false}
                              style={{
                                transform: `scale(${1.01 - activeCaseProgress * 0.015})`,
                        ...
                        <div className="px-5 pb-5 pt-4">
                          ...
                          <p className="mt-3 max-w-[24rem] text-[14px] leading-7 text-neutral-700">
                            {activeCase.content?.summary ?? activeCase.tagline}
                          </p>

                          <div className="mt-4 inline-flex items-center gap-2 text-[11px] uppercase tracking-[0.14em] text-neutral-600 transition-transform duration-300 ease-[cubic-bezier(0.22,1,0.36,1)] group-hover:translate-x-[1px]">
                ...
                {homeCases.map((c) => {
                  ...
                  return (
                    <article
                      ...
                      data-case={c.slug}
                      className={[
                        "flex min-h-[46vh] items-center xl:min-h-[86vh]",
                    ...
                    >
                      ...
                      >
                        <div className="hidden xl:flex xl:w-full xl:flex-row xl:items-start xl:justify-between xl:gap-6">
                          <div className="flex gap-4 sm:gap-5">
                            <div className="w-10 shrink-0">
                              <div className={`text-sm ${isActive ? "text-black" : "text-neutral-500"}`}>{c.index}</div>
                              <div className="mt-2 min-h-[1em] text-[11px] uppercase tracking-[0.14em] text-neutral-400">{c.code}</div>
                            </div>

                            <div>
                              <h2 className="text-[28px] tracking-tight transition duration-300 ease-[cubic-bezier(0.22,1,0.36,1)] group-hover:translate-x-[2px] sm:text-[32px] md:text-[36px] xl:text-4xl">{c.title}</h2>
                              ...
                              <div className="mt-6 inline-flex items-center gap-2 whitespace-nowrap text-[11px] uppercase tracking-[0.14em] text-neutral-500 transition duration-300 ease-[cubic-bezier(0.22,1,0.36,1)] group-hover:text-neutral-800">
                                {t.home.work.view} <span className="text-neutral-400">&rarr;</span>
                              </div>
                            </div>
                          </div>
                        ...
                        <div className="relative mt-10 h-[1px] w-full bg-neutral-100">
                          {isActive ? <div className="absolute left-0 top-0 h-[1px] w-24 bg-neutral-900" /> : null}
                        </div>
                      </button>
                    </article>
                  );
                ...
                >
                  <div className="w-full py-8 md:py-10 xl:py-14">
                    <div className="flex flex-col gap-5 md:flex-row md:items-start md:justify-between md:gap-6">
                      <div className="flex gap-4 sm:gap-5">
                        <div className="w-10 shrink-0">
                          <div className={`text-sm ${isSkills ? "text-black" : "text-neutral-500"}`}>04</div>
                          <div className="mt-2 min-h-[1em] text-[11px] uppercase tracking-[0.14em] text-neutral-400">S-04</div>
                        </div>
                    ...
                    <div className="relative mt-10 h-[1px] w-full bg-neutral-100">
                      {isSkills ? <div className="absolute left-0 top-0 h-[1px] w-24 bg-neutral-900" /> : null}
                    </div>
                  </div>
                </article>
                ...
                >
                  <div className="w-full py-8 md:py-10 xl:py-14">
                    <div className="flex flex-col gap-5 md:flex-row md:items-start md:justify-between md:gap-6">
                      <div className="flex gap-4 sm:gap-5">
                        <div className="w-10 shrink-0">
                          <div className={`text-sm ${isServices ? "text-black" : "text-neutral-500"}`}>05</div>
                          <div className="mt-2 min-h-[1em] text-[11px] uppercase tracking-[0.14em] text-neutral-400">P-05</div>
                        </div>
                      ...
                      <div className="text-sm text-neutral-400">Packages</div>
                    </div>

                    <div className="relative mt-10 h-[1px] w-full bg-neutral-100">
                      {isServices ? <div className="absolute left-0 top-0 h-[1px] w-24 bg-neutral-900" /> : null}
                    </div>
                  </div>
                </article>
              </div>
          ...
          >
            <div className="grid gap-10 md:grid-cols-[0.42fr_0.58fr]">
              ...
              >
                ...
                <h2 className="mt-3 text-3xl tracking-tight md:text-[42px]">{t.home.about.title}</h2>
              ...
              >
                <div className="rounded-[20px] border border-neutral-100 bg-white/72 p-4 backdrop-blur-[2px] transition duration-300 ease-[cubic-bezier(0.22,1,0.36,1)] hover:border-neutral-200 hover:bg-white/88 hover:translate-y-[-1px]">
                  <div className="text-[11px] uppercase tracking-[0.14em] text-neutral-500">Best role fit</div>
                  <div className="mt-2 text-sm text-neutral-700">Creative Developer / Interactive Web Developer / Design Engineer / Premium Front-end Systems Builder.</div>
                </div>

                <div className="rounded-[20px] border border-neutral-100 bg-white/72 p-4 backdrop-blur-[2px] transition duration-300 ease-[cubic-bezier(0.22,1,0.36,1)] hover:border-neutral-200 hover:bg-white/88 hover:translate-y-[-1px]">
                  <div className="text-[11px] uppercase tracking-[0.14em] text-neutral-500">Core stack</div>
                  <div className="mt-2 text-sm text-neutral-700">React, TypeScript, Astro, Next.js, Vite, Tailwind CSS, motion systems, structured content architecture.</div>
                </div>
            ...
            <div className="grid gap-10 md:grid-cols-[0.55fr_0.45fr]">
              ...
              >
                ...
                <div className="mt-8 flex flex-wrap items-center gap-2.5">
                  ...
                  >
                    {t.home.contact.email} <span className="text-neutral-400">&rarr;</span>
                  </a>

                  <button
                    type="button"
                    onClick={() => navigator.clipboard?.writeText("info@brenych.com")}
                     className="inline-flex items-center whitespace-nowrap rounded-full border border-neutral-200 bg-white px-4 py-2.5 text-[11px] uppercase tracking-[0.14em] text-neutral-700 transition duration-300 ease-[cubic-bezier(0.22,1,0.36,1)] hover:border-neutral-400 hover:translate-y-[-1px] hover:text-neutral-900"
                  >
                    {t.home.contact.copy}
                  </button>
              ...
              >
                <div className="rounded-[20px] border border-neutral-100 bg-white/72 p-4 backdrop-blur-[2px] transition duration-300 ease-[cubic-bezier(0.22,1,0.36,1)] hover:border-neutral-200 hover:bg-white/88 hover:translate-y-[-1px]">
                  ...
                  <div className="mt-2 text-sm text-neutral-900">info@brenych.com</div>
                  <div className="mt-1 text-xs text-neutral-500">Best for briefs & references.</div>
                </div>

                <div className="rounded-[20px] border border-neutral-100 bg-white/72 p-4 backdrop-blur-[2px] transition duration-300 ease-[cubic-bezier(0.22,1,0.36,1)] hover:border-neutral-200 hover:bg-white/88 hover:translate-y-[-1px]">
                  <div className="text-[11px] uppercase tracking-[0.14em] text-neutral-500">Location</div>
                  <div className="mt-2 text-sm text-neutral-900">Barcelona / EU</div>
