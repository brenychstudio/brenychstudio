      ...
      >
        ...
        <div className="relative mx-auto w-[min(92vw,1640px)] py-10 sm:py-12 lg:w-[min(94vw,1640px)]">
          ...
          <div className="grid gap-6 border-b border-neutral-950/[0.08] py-7 lg:grid-cols-[minmax(0,1fr)_minmax(0,1fr)_minmax(0,1fr)_minmax(0,0.82fr)] lg:items-start">
            ...
            <FooterLedgerLinks title={t.footer.routes} links={localizedRouteLinks} className="lg:justify-self-end" />
          </div>
      ...
      <div className="relative mx-auto w-[min(92vw,1640px)] py-10 sm:py-12 lg:w-[min(94vw,1640px)] lg:py-14">
        {!hideClosingSignal ? (
          <div className="grid gap-8 border-b border-neutral-950/[0.08] pb-9 lg:grid-cols-[minmax(0,0.6fr)_minmax(25rem,34rem)] lg:items-end">
            ...
            <div className="border-y border-neutral-950/14 bg-white/20 py-4 backdrop-blur-sm lg:justify-self-end lg:w-full lg:max-w-[34rem] lg:translate-x-32">
