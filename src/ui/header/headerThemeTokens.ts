...
export const headerSceneThemes: Record<string, HeaderTheme> = {
  ...
  "presence-os-threshold": {
    id: "presence-os-threshold",
    signalLabel: "MEMORY ATLAS",
    ...darkProof,
    surface: "rgba(5, 9, 10, 0.78)",
    elevation: 0.22,
  },
  "presence-os-walkthrough": {
    id: "presence-os-walkthrough",
    signalLabel: "PRESENCE FIELD",
    ...darkProof,
    surface: "rgba(5, 8, 10, 0.76)",
    elevation: 0.2,
  },
  "presence-os-xr": {
    id: "presence-os-xr",
    signalLabel: "XR MEMORY ROOM",
    ...darkProof,
    surface: "rgba(4, 6, 9, 0.78)",
    elevation: 0.22,
  },
  "presence-os-artifact": {
    id: "presence-os-artifact",
    signalLabel: "LOCAL ARTIFACTS",
    ...darkProof,
    surface: "rgba(6, 7, 8, 0.76)",
    elevation: 0.2,
  },
  "presence-os-technical": {
    id: "presence-os-technical",
    signalLabel: "LOCAL-FIRST ENGINE",
    ...darkProof,
    surface: "rgba(5, 7, 8, 0.76)",
    elevation: 0.2,
  },
  "orbit-lens-threshold": {
    id: "orbit-lens-threshold",
    signalLabel: "ORBIT LENS OS",
    ...darkProof,
    surface: "rgba(5, 8, 10, 0.78)",
    elevation: 0.22,
  },
  "orbit-lens-fields": {
    id: "orbit-lens-fields",
    signalLabel: "SPATIAL FIELDS",
    ...darkProof,
    surface: "rgba(5, 8, 10, 0.76)",
    elevation: 0.2,
  },
  ...
  "orbit-lens-xr": {
    id: "orbit-lens-xr",
    signalLabel: "WEBXR PROOF",
    ...darkProof,
    surface: "rgba(4, 6, 9, 0.78)",
    elevation: 0.22,
  },
  "orbit-lens-technical": {
    id: "orbit-lens-technical",
    signalLabel: "OPTICAL STACK",
    ...darkProof,
    surface: "rgba(5, 7, 9, 0.76)",
    elevation: 0.2,
  },
  "evidence-threshold": {
